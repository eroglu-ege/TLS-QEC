...
01_validate.py
==============
Validate numeric closed-system solver against analytic Rabi formula.
Thermal population does not affect the closed system (no dissipation),
so this script is temperature-independent.
...
def run_validation():
    ...
    for i, case in enumerate(CASES):
        ...
        print(f"\n  {case['label']}: Δ={delta:.2f}, g={g:.3f}, Ω_R={Omega_R:.4f}")
        ...
        ax2 = ax.twinx()
        ax2.plot(res['t'], error, color='red', lw=1, alpha=0.5)
